...
function busImg(modelId,livery){
  ...
  return `<div class="busimg" style="border-color:${livery||'#2a3650'}">`
    +`<img src="${src}" alt="${m.nama}" loading="lazy" `
    +`onerror="this.outerHTML=busSVG('${modelId}','${livery||'#1f5fd0'}')">`
    +`</div>`;
}
